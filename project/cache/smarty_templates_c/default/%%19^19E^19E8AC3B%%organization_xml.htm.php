<?php /* Smarty version 2.6.26, created on 2011-04-11 11:15:42
         compiled from organization_xml.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'organization_xml.htm', 11, false),array('modifier', 'default', 'organization_xml.htm', 16, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
?>
    <row>
        <cell><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]->getOrgId(); ?>
</cell>
        ...
        <?php $this->assign('creator', $this->_tpl_vars['list'][$this->_sections['i']['index']]->getCreator()); ?>
        <cell><?php echo $this->_tpl_vars['creator']->getNickName(); ?>
</cell>
        <cell><?php echo $this->_tpl_vars['creator']->getLoginName(); ?>
</cell>
