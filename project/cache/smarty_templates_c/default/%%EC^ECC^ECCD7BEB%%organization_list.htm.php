<?php /* Smarty version 2.6.26, created on 2011-04-25 00:41:34
         compiled from organization_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'organization_list.htm', 14, false),)), $this); ?>
<?php ob_start(); ?>
<style>
    .ui-dialog{
        font-size:80%
...
<script>
    $(function(){
        $("#list").jqGrid({
            ...
            colNames: [
                '#',
                '<?php echo ((is_array($_tmp='Organization Name')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
',
                '<?php echo ((is_array($_tmp='Creator Nickname')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
',
                '<?php echo ((is_array($_tmp='Creator LoginName')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
',
...
',
            ...
            colModel:[
                ...
                {name:'type',index:'type',width:50,formatter:function(v){return v==0 ? '<?php echo ((is_array($_tmp='PUBLIC')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
...
';}},
            ...
            viewrecords: true,
            sortorder: "desc",
            caption:"<?php echo ((is_array($_tmp='Organization')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
",
            width:800,
            height:300,
...
"><?php echo $this->_tpl_vars['b']->getName(); ?>
    ...
    <span><a href="?action=create"><img src="./images/add_organization_icon.jpg"><?php echo ((is_array($_tmp='Create Your Organization')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</a></span>
	</td>
	</table>
</center>
