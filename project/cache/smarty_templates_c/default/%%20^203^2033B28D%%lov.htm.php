<?php /* Smarty version 2.6.26, created on 2011-05-08 01:41:08
         compiled from lov.htm */ ?>
...
",
            ...
            ondblClickRow:function(rowid, iRow, iCol, e){
                ...
                window.opener.setData('<?php echo $this->_tpl_vars['k']; ?>
',row['<?php echo $this->_tpl_vars['pk']; ?>
'],row['toString']);
                window.close();
            }
        });
...
*/
    ...
    <body>
        ...
        <center>
            <label><input id="incdelcb" type="checkbox" /> Include Deleted</label>
        </center>
<table width="100%">
    <tr>
        <td align="center">
