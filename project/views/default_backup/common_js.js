...
function showAccount(loginid){
  new showDialog("http://"+location.host+"/account.php?action=viewDetail&type=iframe&loginName="+loginid,undefined,undefined,"<{'User Info of'|lang}> "+loginid);
}
