                ...
                if (($v & Mgt::TYPE_DETAIL) != 0) {
                    ...
                    if ($mgtobj->fk[$k] instanceof ReflectionClass) {
                        ...
                        //        echo $r->$m() . ":" . $inst->__toString();
                                echo "<input type='text' name='$k' value='".htmlspecialchars($r->$m())."'".($this->getDisableProp($mgtobj->getPropName($k))?" disabled":"")."><input type='button' value='v'".($this->getDisableProp($mgtobj->getPropName($k))?" disabled":"")."><span>".$inst->__toString()."</span>";
                            } else {
                                echo "<input type='text' name='$k'".($this->getDisableProp($mgtobj->getPropName($k))?" disabled":"")."><input type='button' value='v'".($this->getDisableProp($mgtobj->getPropName($k))?" disabled":"")."><span></span>";
