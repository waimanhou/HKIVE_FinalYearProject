 ...
 * Example, change a variable value only if it is null (great for $_REQUEST variables):
 *
 * {* $foo is a null variable *}
 * {set var=$foo value="bar" if=is_null}
 * Example, create a full array:
 *
 * {set var=$foo value=array('bar' => 2, 'foo' => array('a', 'b', 'c'))}
 *
 *
 *
